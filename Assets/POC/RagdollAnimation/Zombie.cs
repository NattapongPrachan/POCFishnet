...
public class Zombie : MonoBehaviour
{
    ...
    [SerializeField] ZombieState _currentState = ZombieState.Walking;
    [SerializeField] Animator _animator;
    [SerializeField] CharacterController _characterController;
    [SerializeField] float _timeToWakeUp;
    [SerializeField] Transform _hipsBone;

    [SerializeField] BoneTransform[] _faceUpStandUpBoneTransforms;
    [SerializeField] BoneTransform[] _faceDownStandUpBoneTransforms;
    [SerializeField] BoneTransform[] _ragdollBoneTransforms;
    [SerializeField] Transform[] _bones;
    [SerializeField] float _elapsedResetBonesTime;
    [SerializeField] bool _isFacingUp;
    ...
    void Awake()
    {
        ...
        Debug.Log("_faceUpStandUpBoneTransforms "+_faceUpStandUpBoneTransforms.Length);
        Debug.Log("_faceDownStandUpBoneTransforms "+_faceDownStandUpBoneTransforms.Length);
        Debug.Log("_ragdollBoneTransforms "+_ragdollBoneTransforms.Length);
    ...
    private Rigidbody FindHitRigidbody(Vector3 hitPoint)
    {
        ...
        Debug.Log("_ragdollRigidbodies "+_ragdollRigidbodies.Count());
        foreach (var rigidbody in _ragdollRigidbodies)
        {
            float distance = Vector3.Distance(rigidbody.position, hitPoint);
            Debug.Log("distancee "+distance);
        ...
        Debug.Log("closestRigidbody "+closestRigidbody);
